...
""" The purpose of this document in Sentinel Prime is to serve as an example of how we used RANSAC in project Sentinel. 
So far, does not have any purpose in the actual operation of Sentinel Prime"""
import sys
import ast
